 ...
 * Rule: DCL07-C
 * Source: testcases
 * Status: PASS - Functions found by prescan should not be flagged for missing prototypes
 ...
 * flagged because they are called before any prototype or definition is visible.
...
void caller_function(void) {
     ...
     * DCL07-C would flag them for missing type information,
