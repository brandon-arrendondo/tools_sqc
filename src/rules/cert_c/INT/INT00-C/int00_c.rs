            ...
            if text.contains("fscanf") || text.contains("scanf") {
                ...
                if text.contains("%ld") && !text.contains("long") {
                    ...
                    violations.push(RuleViolation {
                        ...
                        message: "Format specifier %ld used with int variable; use %d for int".to_string(),
                        suggestion: Some("Use correct format specifier matching variable type".to_string()),
            ...
            if text.contains("(unsigned long)") && text.contains("*") && !text.contains("uintmax_t") {
                ...
                if lines_before.contains("unsigned int") {
                    violations.push(RuleViolation {
                        ...
                        column: node.start_position().column + 1,
                        file_path: String::new(),
                        message: "Unsafe integer conversion; result may not fit in unsigned long".to_string(),
                        suggestion: Some("Use uintmax_t for guaranteed safe conversion".to_string()),
                        requires_manual_review: None,
                    });
                }
            }
