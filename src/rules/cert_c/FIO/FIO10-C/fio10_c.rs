...
mod tests {
    ...
    fn test_unchecked_rename() {
        ...
        assert!(
            !violations.is_empty(),
            "Should detect unchecked rename() call"
        );
    }

    #[test]
    fn test_checked_rename() {
        let code = r#"
            void func(void) {
        ...
        assert!(
            violations.is_empty(),
            "Should not flag rename() with error checking: {:?}",
            violations
        );
    }

    #[test]
    fn test_toctou_access_rename() {
        let code = r#"
            void func(void) {
        ...
        // Should detect both TOCTOU and unchecked rename
        assert!(
            violations.len() >= 1,
            "Should detect TOCTOU or unchecked rename"
        );
    }
}
