...
reviews: []
related_files:
  - src/rules/cert_c/FIO/FIO24-C/
  - src/rules/cert_c/mod.rs
  - src/utility/cert_c/
---

# P2-FIO24-C - FIO24-C Implementation
...
Implement or verify FIO24-C with 100% test pass rate and DRY compliance.

### Requirements:
1. Study the CERT C wiki page for FIO24-C
2. Check if implementation exists in `src/rules/cert_c/FIO/FIO24-C/`
