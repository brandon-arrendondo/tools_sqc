...
Implement or verify SIG00-C with 100% test pass rate and DRY compliance.

### Requirements:
1. Study the CERT C wiki page for SIG00-C
2. Check if implementation exists in `src/rules/cert_c/SIG/SIG00-C/`
