...
reviews: []
related_files:
  - src/rules/cert_c/FIO/FIO03-C/
  - src/rules/cert_c/mod.rs
  - src/utility/cert_c/
---

# P2-FIO03-C - FIO03-C Implementation
...
**Wiki Reference:**
https://wiki.sei.cmu.edu/confluence/display/c/FIO03-C.+Do+not+make+assumptions+about+fopen()+and+file+creation

---

## Task

Implement or verify FIO03-C with 100% test pass rate and DRY compliance.

### Requirements:
1. Study the CERT C wiki page for FIO03-C
2. Check if implementation exists in `src/rules/cert_c/FIO/FIO03-C/`
