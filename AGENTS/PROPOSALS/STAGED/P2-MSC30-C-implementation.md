...
**Wiki Reference:**
https://wiki.sei.cmu.edu/confluence/display/c/MSC30-C.+Do+not+use+the+rand()+function+for+generating+pseudorandom+numbers

---

## Task

Implement or verify MSC30-C with 100% test pass rate and DRY compliance.

### Requirements:
1. Study the CERT C wiki page for MSC30-C
2. Check if implementation exists in `src/rules/cert_c/MSC/MSC30-C/`
