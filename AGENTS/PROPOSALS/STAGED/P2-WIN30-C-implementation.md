...
tags:
  ...
  - WIN
related_files:
  - src/rules/cert_c/WIN/WIN30-C/
  - src/rules/cert_c/mod.rs
  - src/utility/cert_c/
---

# P2-WIN30-C - WIN30-C Implementation
...
**Wiki Reference:**
https://wiki.sei.cmu.edu/confluence/display/c/WIN30-C.+Properly+pair+allocation+and+deallocation+functions

---

## Task

Implement or verify WIN30-C with 100% test pass rate and DRY compliance.

### Requirements:
1. Study the CERT C wiki page for WIN30-C
2. Check if implementation exists in `src/rules/cert_c/WIN/WIN30-C/`
