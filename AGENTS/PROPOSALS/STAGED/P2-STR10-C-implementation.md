...
Implementation file exists at `src/rules/cert_c/STR/STR10-C/str10_c.rs` and is registered in mod.rs. The rule detects unsafe string manipulation functions. Implementation needs test verification and documentation update.
