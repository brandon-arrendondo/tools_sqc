...
reviews: []
related_files:
  - src/rules/cert_c/EXP/EXP32-C/
  - src/rules/cert_c/mod.rs
  - src/utility/cert_c/
---

# P2-EXP32-C - EXP32-C Implementation
...
**Wiki Reference:**
https://wiki.sei.cmu.edu/confluence/display/c/EXP32-C.+Do+not+access+a+volatile+object+through+a+nonvolatile+reference

---

## Task

Implement or verify EXP32-C with 100% test pass rate and DRY compliance.

### Requirements:
1. Study the CERT C wiki page for EXP32-C
2. Check if implementation exists in `src/rules/cert_c/EXP/EXP32-C/`
