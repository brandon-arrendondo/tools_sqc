...
tags:
  ...
  - STR
related_files:
  - src/rules/cert_c/STR/STR04-C/
  - src/rules/cert_c/mod.rs
  - src/utility/cert_c/
---

# P2-STR04-C - STR04-C Implementation
...
**Wiki Reference:**
https://wiki.sei.cmu.edu/confluence/display/c/STR04-C.+Use+plain+char+for+characters+in+the+basic+character+set

---

## Task

Implement or verify STR04-C with 100% test pass rate and DRY compliance.

### Requirements:
1. Study the CERT C wiki page for STR04-C
2. Check if implementation exists in `src/rules/cert_c/STR/STR04-C/`
