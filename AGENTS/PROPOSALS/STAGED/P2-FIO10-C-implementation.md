...
reviews: []
related_files:
  - src/rules/cert_c/FIO/FIO10-C/
  - src/rules/cert_c/mod.rs
  - src/utility/cert_c/
---

# P2-FIO10-C - FIO10-C Implementation
...
**Wiki Reference:**
https://wiki.sei.cmu.edu/confluence/display/c/FIO10-C.+Take+care+when+using+the+rename()+function

---

## Task

Implement or verify FIO10-C with 100% test pass rate and DRY compliance.

### Requirements:
1. Study the CERT C wiki page for FIO10-C
2. Check if implementation exists in `src/rules/cert_c/FIO/FIO10-C/`
