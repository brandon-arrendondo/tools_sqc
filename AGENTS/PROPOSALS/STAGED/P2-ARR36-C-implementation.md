...
**2025-11-19: Implementation Verified and Complete**

- Rule ARR36-C already exists with complete implementation
- All 42 tests passing (100% pass rate):
  - 31 fail test cases correctly detect violations
  - 11 pass test cases correctly allow compliant code
- Rule is properly registered in `src/rules/cert_c/mod.rs`
- Rule is enabled in configuration (`ARR36-C.toml`)
...
- Detects pointer comparisons (<, <=, >, >=) between pointers from different arrays
- Properly handles:
  - Multiple allocation sources (malloc, calloc, aligned_alloc, compound literals, string literals)
  - Struct/union members
  - Function parameters
  - Multi-dimensional arrays
  - Various storage classes (static, extern, thread_local, etc.)
  - Pointer arithmetic and nested expressions
