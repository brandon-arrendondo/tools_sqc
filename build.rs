...
fn generate_integration_tests() -> Result<()> {
    ...
    for category_entry in category_entries {
        ...
        for rule_entry in rule_entries {
            ...
            // Write per-rule file header
            writeln!(rule_file, "// Auto-generated tests for {}", rule_id)?;
            writeln!(rule_file, "// DO NOT EDIT - Generated by build.rs\n")?;
            writeln!(rule_file, "use crate::parser::CParser;")?;
            writeln!(rule_file, "use crate::rules::{{CertRule, RuleRegistry}};")?;
            writeln!(rule_file, "use std::path::Path;\n")?;
    ...
    // Generate main integration_tests.rs with module includes
    ...
    for rule_module in &rule_modules {
        writeln!(main_file, "    #[path = \"tests/{}_tests.rs\"]", rule_module)?;
        writeln!(main_file, "    mod {};", rule_module)?;
    }
