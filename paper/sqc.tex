...
\midrule
121 & Stack Buffer Overflow       & 48.8 & 40.5 & 86.6 & 38.8 & --- \\
122 & Heap Buffer Overflow        & 58.5 & 45.0 & \textbf{89.5} & 37.8 & --- \\
124 & Buffer Underwrite           & 52.1 & 40.5 & \textbf{90.4} & 33.9 & --- \\
127 & Buffer Underread            & 55.6 & 42.7 & \textbf{93.2} & 33.9 & --- \\
190 & Integer Overflow            & 47.4 & 27.5 & 94.3 & --- & 58.1 \\
191 & Integer Underflow           & 45.5 & 27.2 & 94.4 & --- & 63.1 \\
197 & Numeric Truncation          & 70.2 & 40.0 & 94.5 & --- & \textbf{100.0} \\
369 & Divide by Zero              & 36.9 & 27.4 & \textbf{94.7} & --- & 43.4 \\
401 & Memory Leak                 & 50.7 & 25.7 & 83.9 & 54.7 & --- \\
415 & Double Free                 & 43.4 & 33.8 & 80.0 & 63.0 & --- \\
416 & Use After Free              & 43.9 & 29.6 & \textbf{60.3} & 2.0  & --- \\
476 & Null Pointer Deref          & 50.8 & 39.7 & \textbf{94.3} & 66.1 & 64.2 \\
680 & Int Overflow $\to$ BOF      & 53.9 & 40.8 & \textbf{95.9} & --- & 82.6 \\
690 & Null Deref from Return      & \textbf{94.6} & 45.7 & 88.0 & 60.0 & --- \\
761 & Free Not at Start           & \textbf{100.0} & 45.7 & 94.3 & 58.1 & --- \\
\midrule
\multicolumn{2}{@{}l}{\textbf{Overall TP rate}} & 54.8 & 36.4 & \textbf{91.6} & 43.6 & 61.0 \\
\multicolumn{2}{@{}l}{\textbf{CWEs tested}}     & \textbf{118} & 15 & 15 & 10 & 6 \\
\bottomrule
\end{tabular}
\caption{TP rate (\%) comparison on overlapping Juliet CWEs.
\textbf{Bold} = highest per row.  ``---'' = CWE not tested by that tool.
SqC v0.3.74; cppcheck 2.10; clang-tidy (LLVM 21.1); Infer v1.2.0; Frama-C 32.0 EVA.
...
violations than SqC (13{,}952 vs.\ 27{,}882 TP).

Second, \textbf{Frama-C and Infer excel on their specialties}: Frama-C
reaches 100\% on numeric truncation (CWE-197) and 82.6\% on integer
overflow to buffer overflow (CWE-680); Infer achieves 66.1\% on null
dereference (CWE-476) and 63.0\% on double-free (CWE-415).

Third, \textbf{SqC wins on two CWEs outright}: CWE-690 (94.6\%, where
inter-procedural null propagation from return values gives it an edge)
...
The coverage gap remains the key differentiator: SqC tests 118 CWEs
