...
files across 11 overlapping CWEs (null dereference, use-after-free,
memory leak, double-free, buffer overflow).  On CWE-476 (null
pointer dereference), Infer achieves 66.1\% TP rate (242~TP / 124~FP)
compared to SqC's 38.5\%.  Infer's separation-logic engine is more
precise for null paths it can model, but covers fewer defect classes
overall.  Full results across all 11 CWEs are pending.
