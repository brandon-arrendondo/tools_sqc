...
41.1\% to 72.6\%, with 36 of 74 CWEs achieving 100\% precision (zero
...
\Cref{tab:juliet-summary} summarizes SqC v0.4.17's performance on
...
Test files & 50,038 \\
True Positives & 24,613 \\
False Positives & 9,270 \\
TP Rate (precision) & 72.6\% \\
Per-file detection rate & 42.1\% \\
100\% precision CWEs & 36 \\
\bottomrule
\end{tabular}
\caption{SqC v0.4.17 Juliet benchmark summary (fast mode).}
...
High ($>$50\%) & 26 & 50--99\% & 17,417 \\
Medium (33--50\%) & 5 & 33--50\% & 350 \\
Low ($<$33\%) & 0 & --- & 0 \\
Zero Detection & 7 & --- & 0 \\
\midrule
\textbf{Total} & \textbf{67}\textsuperscript{$\dagger$} & & \textbf{24,613} \\
\bottomrule
\end{tabular}
\caption{CWE distribution by precision tier (fast mode, v0.4.17).
...
\midrule
INT32-C & 3,399 & 1,767 & 34 & 190, 191, 680 \\
INT31-C & 2,194 & 1,248 & 36 & 195, 194, 197 \\
...
\bottomrule
\end{tabular}
\caption{Top 10 rules by true positive volume (fast mode, v0.4.17).}
\label{tab:top-rules}
\end{table}
...
a new baseline of 45.8\%, which has since improved to 72.6\% through
...
\begin{axis}[
    ...
    ymin=40, ymax=76,
    xtick=data,
    xticklabels={v0.2.1, v0.2.7, v0.2.23, v0.3.20, v0.3.37, v0.3.53, v0.3.75, v0.3.84, v0.3.99, v0.3.119, v0.4.5, v0.4.9, v0.4.17},
...
\addplot[color=blue, mark=*, thick] coordinates {
    (1, 41.1) (2, 44.5) (3, 44.6) (4, 45.8) (5, 48.4) (6, 52.0) (7, 56.3) (8, 60.2) (9, 63.6) (10, 67.5) (11, 69.4) (12, 70.4) (13, 72.6)
};
\end{axis}
\end{tikzpicture}
\caption{TP rate progression from baseline (v0.2.1) through current
(v0.4.17).  The gap between v0.2.23 and v0.3.20 reflects the switch
...
190 & Integer Overflow            & 66.8 & 27.5 & \textbf{94.3} & --- & 58.1 \\
191 & Integer Underflow           & \textbf{63.3} & 27.2 & \textbf{94.4} & --- & 63.1 \\
197 & Numeric Truncation          & 70.2 & 40.0 & 94.5 & --- & \textbf{100.0} \\
369 & Divide by Zero              & 56.1 & 27.4 & \textbf{94.7} & --- & 43.4 \\
...
680 & Int Overflow $\to$ BOF      & 60.0 & 40.8 & \textbf{95.9} & --- & 82.6 \\
690 & Null Deref from Return      & \textbf{100.0} & 45.7 & 88.0 & 60.0 & --- \\
761 & Free Not at Start           & \textbf{100.0} & 45.7 & 94.3 & 58.1 & --- \\
\midrule
\multicolumn{2}{@{}l}{\textbf{Overall TP rate}} & 67.6 & 36.4 & \textbf{91.6} & 43.6 & 61.0 \\
...
SqC v0.4.17; cppcheck 2.10; clang-tidy (LLVM 21.1); Infer v1.2.0; Frama-C 32.0 EVA.
Competitor numbers are held fixed; SqC's column reflects v0.4.17.
...
violations than SqC (13{,}952 vs.\ 24{,}613 TP).

Second, \textbf{SqC has surpassed Frama-C} on the 15 overlapping CWEs:
67.6\% vs.\ Frama-C's 61.0\%, while covering 74 CWEs vs.\ Frama-C's 6.
SqC now exceeds Frama-C on CWE-369 (56.1\% vs.\ 43.4\%), CWE-190
(66.8\% vs.\ 58.1\%), and CWE-191 (63.3\% vs.\ 63.1\%).
...
41.1\% to 72.6\%, organized by the insight that motivated each change.
...
v0.4.17 & VRA + STR31-C + EXP33-C & 9.3K & $-$2.4K & 72.6 \\
\bottomrule
\end{tabular}
\caption{FP reduction milestones.  Full-suite rounds 0--12 reduced FP by
80.7\%.  Fast-mode continued from 45.8\% to 72.6\% TP rate.  The v0.4.17
row reflects continued VRA improvements, STR31-C buffer-size inference,
and EXP33-C inter-procedural FP suppression.}
...
propagation)---has reached 72.6\% TP rate, surpassing the previously
...
(including cross-function taint propagation), SqC achieves a 72.6\%
true positive rate on the Juliet benchmark with 36 CWEs at 100\%
precision.  On a five-tool comparison, SqC surpasses Frama-C
(67.6\% vs.\ 61.0\% on overlapping CWEs) while covering 5--12$\times$
