...
\newblock arXiv preprint arXiv:2510.02534, 2025.
\newblock \url{https://arxiv.org/abs/2510.02534}.

\bibitem{pathfeasibility}
{Minimizing False Positives in Static Bug Detection via LLM-Enhanced Path
  Feasibility Analysis}.
\newblock arXiv preprint arXiv:2506.10322, 2025.
\newblock \url{https://arxiv.org/abs/2506.10322}.

\bibitem{siftingnoise}
{Sifting the Noise: A Comparative Study of LLM Agents in Vulnerability False
  Positive Filtering}.
\newblock arXiv preprint arXiv:2601.22952, 2026.
\newblock \url{https://arxiv.org/abs/2601.22952}.

\bibitem{primevul}
Y.~Ding et~al.
\newblock {Vulnerability Detection with Code Language Models: How Far Are We?}
\newblock In \emph{Proceedings of the IEEE/ACM 47th International Conference on
  Software Engineering (ICSE)}, 2025.
\newblock \url{https://arxiv.org/abs/2403.18624}.
