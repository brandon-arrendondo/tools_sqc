...
# benchmarking_db queue MCP server -- keeps this interactive session's
...
set +a
exec python3 /home/brandon/data-enterprise/benchmarking_db/mcp_servers/queue_server.py
