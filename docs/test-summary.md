...
- [ARR](#category-arr) (8 implemented / 9 total)
  ...
  - ✅ [ARR30-C](#rule-arr30c) - Implemented: Pass 57/61 (93.4%)
...
**Test Results:** 57/61 passed (93.4%)
...
- ✅ PASS `testcases_enum_over.c` → `test_arr30_c_fail_testcases_enum_over`
...
- ✅ PASS `testcases_input_over.c` → `test_arr30_c_fail_testcases_input_over`
- ✅ PASS `testcases_loop_overrun.c` → `test_arr30_c_fail_testcases_loop_overrun`
...
- ✅ PASS `testcases_off_by_one.c` → `test_arr30_c_fail_testcases_off_by_one`
...
- ✅ PASS `testcases_ternary_over.c` → `test_arr30_c_fail_testcases_ternary_over`
...
- ✅ PASS `wiki_forming_out_of_bounds_pointer.c` → `test_arr30_c_fail_wiki_forming_out_of_bounds_pointer`
...
- ✅ PASS `wiki_using_past_the_end_index.c` → `test_arr30_c_fail_wiki_using_past_the_end_index`
