...
- [API](#category-api) (7 implemented / 9 total)
  ...
  - ✅ [API10-C](#rule-api10c) - Implemented: Pass 0/2 (0.0%) [2 not run]
  - ✅ [API07-C](#rule-api07c) - Implemented: Pass 0/2 (0.0%) [2 not run]
...
- [CON](#category-con) (1 implemented / 23 total)
  ...
  - ✅ [CON05-C](#rule-con05c) - Implemented: Pass 0/2 (0.0%) [2 not run]
