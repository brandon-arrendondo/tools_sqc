...
- [EXP](#category-exp) (9 implemented / 31 total)
  ...
  - ✅ [EXP12-C](#rule-exp12c) - Implemented: Pass 2/2 (100.0%)
  ...
  - ✅ [EXP13-C](#rule-exp13c) - Implemented: Pass 2/2 (100.0%)
  ...
  - ✅ [EXP35-C](#rule-exp35c) - Implemented: Pass 7/7 (100.0%)
...
- ✅ PASS `wiki_noncompliant_1.c` → `test_exp12_c_fail_wiki_noncompliant_1`

#### Pass Tests (Should NOT Detect Violations)

- ✅ PASS `wiki_compliant_1.c` → `test_exp12_c_pass_wiki_compliant_1`
...
- ✅ PASS `wiki_noncompliant_1.c` → `test_exp13_c_fail_wiki_noncompliant_1`

#### Pass Tests (Should NOT Detect Violations)

- ✅ PASS `wiki_compliant_1.c` → `test_exp13_c_pass_wiki_compliant_1`
...
- ✅ PASS `wiki_noncompliant_1.c` → `test_exp35_c_fail_wiki_noncompliant_1`
- ✅ PASS `wiki_noncompliant_2.c` → `test_exp35_c_fail_wiki_noncompliant_2`
- ✅ PASS `wiki_noncompliant_3.c` → `test_exp35_c_fail_wiki_noncompliant_3`

#### Pass Tests (Should NOT Detect Violations)

- ✅ PASS `wiki_c11_and_newer.c` → `test_exp35_c_pass_wiki_c11_and_newer`
- ✅ PASS `wiki_compliant_2.c` → `test_exp35_c_pass_wiki_compliant_2`
- ✅ PASS `wiki_compliant_3.c` → `test_exp35_c_pass_wiki_compliant_3`
- ✅ PASS `wiki_compliant_4.c` → `test_exp35_c_pass_wiki_compliant_4`
