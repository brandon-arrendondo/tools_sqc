...
- [API](#category-api) (6 implemented / 9 total)
  ...
  - ✅ [API03-C](#rule-api03c) - Implemented: Pass 3/3 (100.0%)
...
- ✅ PASS `wiki_interface.c` → `test_api03_c_fail_wiki_interface`
- ✅ PASS `wiki_interface_2.c` → `test_api03_c_fail_wiki_interface_2`

#### Pass Tests (Should NOT Detect Violations)

- ✅ PASS `wiki_interface.c` → `test_api03_c_pass_wiki_interface`
