...
- [API](#category-api) (0 implemented / 9 total)
  - 🔶 [API05-C](#rule-api05c) - Not Implemented (has tests): Pass 0/4 (0.0%) [4 not run]
  ...
  - 🔶 [API00-C](#rule-api00c) - Not Implemented (has tests): Pass 0/42 (0.0%) [42 not run]
  - 🔶 [API02-C](#rule-api02c) - Not Implemented (has tests): Pass 0/2 (0.0%) [2 not run]
  - 🔶 [API03-C](#rule-api03c) - Not Implemented (has tests): Pass 0/3 (0.0%) [3 not run]
  - 🔶 [API01-C](#rule-api01c) - Not Implemented (has tests): Pass 0/3 (0.0%) [3 not run]
  - 🔶 [API09-C](#rule-api09c) - Not Implemented (has tests): Pass 0/2 (0.0%) [2 not run]
  - 🔶 [API04-C](#rule-api04c) - Not Implemented (has tests): Pass 0/2 (0.0%) [2 not run]
- [ARR](#category-arr) (7 implemented / 9 total)
  - ✅ [ARR00-C](#rule-arr00c) - Implemented: Pass 39/39 (100.0%)
  - 🔶 [ARR01-C](#rule-arr01c) - Not Implemented (has tests): Pass 0/65 (0.0%) [65 not run]
...
- [ERR](#category-err) (1 implemented / 11 total)
  ...
  - ✅ [ERR33-C](#rule-err33c) - Implemented: Pass 48/51 (94.1%)
...
- [FIO](#category-fio) (2 implemented / 35 total)
  - ✅ [FIO34-C](#rule-fio34c) - Implemented: Pass 43/48 (89.6%)
  ...
  - ✅ [FIO30-C](#rule-fio30c) - Implemented: Pass 21/45 (46.7%)
  - 🔶 [FIO37-C](#rule-fio37c) - Not Implemented (has tests): Pass 0/2 (0.0%) [2 not run]
...
- [INT](#category-int) (2 implemented / 23 total)
  - 🔶 [INT36-C](#rule-int36c) - Not Implemented (has tests): Pass 0/5 (0.0%) [5 not run]
  - ✅ [INT32-C](#rule-int32c) - Implemented: Pass 36/56 (64.3%)
  ...
  - 🔶 [INT18-C](#rule-int18c) - Not Implemented (has tests): Pass 0/7 (0.0%) [7 not run]
...
- [MSC](#category-msc) (0 implemented / 8 total)
...
- [POS](#category-pos) (0 implemented / 20 total)
  ...
  - 🔶 [POS30-C](#rule-pos30c) - Not Implemented (has tests): Pass 0/3 (0.0%) [3 not run]
  - 🔶 [POS37-C](#rule-pos37c) - Not Implemented (has tests): Pass 0/3 (0.0%) [3 not run]
  ...
  - 🔶 [POS36-C](#rule-pos36c) - Not Implemented (has tests): Pass 0/2 (0.0%) [2 not run]
...
- [PRE](#category-pre) (3 implemented / 16 total)
  ...
  - 🔶 [PRE09-C](#rule-pre09c) - Not Implemented (has tests): Pass 0/2 (0.0%) [2 not run]
...
- [SIG](#category-sig) (0 implemented / 7 total)
  - 🔶 [SIG01-C](#rule-sig01c) - Not Implemented (has tests): Pass 0/47 (0.0%) [47 not run]
  - 🔶 [SIG30-C](#rule-sig30c) - Not Implemented (has tests): Pass 0/47 (0.0%) [47 not run]
  - 🔶 [SIG34-C](#rule-sig34c) - Not Implemented (has tests): Pass 0/44 (0.0%) [44 not run]
  - 🔶 [SIG31-C](#rule-sig31c) - Not Implemented (has tests): Pass 0/43 (0.0%) [43 not run]
...
- [STR](#category-str) (2 implemented / 16 total)
  - 🔶 [STR00-C](#rule-str00c) - Not Implemented (has tests): Pass 0/40 (0.0%) [40 not run]
  - 🔶 [STR38-C](#rule-str38c) - Not Implemented (has tests): Pass 0/5 (0.0%) [5 not run]
...
- [WIN](#category-win) (0 implemented / 6 total)
  ...
  - 🔶 [WIN02-C](#rule-win02c) - Not Implemented (has tests): Pass 0/2 (0.0%) [2 not run]
  - 🔶 [WIN01-C](#rule-win01c) - Not Implemented (has tests): Pass 0/2 (0.0%) [2 not run]
...
**Implementation Status:** 0 / 9 rules (0.0%)

### 🔶 API05-C - Not Implemented (has tests)
...
### 🔶 API00-C - Not Implemented (has tests)
...
### 🔶 API02-C - Not Implemented (has tests)
...
### 🔶 API01-C - Not Implemented (has tests)
...
### 🔶 API04-C - Not Implemented (has tests)
...
### 🔶 ARR01-C - Not Implemented (has tests)
...
**Test Results:** 48/51 passed (94.1%)
...
- ❌ FAIL `wiki_calloc.c` → `test_err33_c_fail_wiki_calloc`
- ✅ PASS `wiki_fseek.c` → `test_err33_c_fail_wiki_fseek`
- ❌ FAIL `wiki_realloc.c` → `test_err33_c_fail_wiki_realloc`
...
- ❌ FAIL `wiki_setlocale.c` → `test_err33_c_pass_wiki_setlocale`
...
**Test Results:** 27/46 passed (58.7%)
...
- ❌ FAIL `testcases_callback_null.c` → `test_exp34_c_fail_testcases_callback_null`
...
- ❌ FAIL `testcases_fgets_null.c` → `test_exp34_c_fail_testcases_fgets_null`
- ✅ PASS `testcases_file_null.c` → `test_exp34_c_fail_testcases_file_null`
- ❌ FAIL `testcases_func_param.c` → `test_exp34_c_fail_testcases_func_param`
...
- ❌ FAIL `testcases_strdup_fail.c` → `test_exp34_c_fail_testcases_strdup_fail`
...
- ❌ FAIL `testcases_uninitialized.c` → `test_exp34_c_fail_testcases_uninitialized`
- ❌ FAIL `testcases_void_cast.c` → `test_exp34_c_fail_testcases_void_cast`
- ❌ FAIL `wiki_noncompliant_1.c` → `test_exp34_c_fail_wiki_noncompliant_1`
- ✅ PASS `wiki_noncompliant_2.c` → `test_exp34_c_fail_wiki_noncompliant_2`
- ❌ FAIL `wiki_noncompliant_3.c` → `test_exp34_c_fail_wiki_noncompliant_3`
...
- ❌ FAIL `testcases_conditional.c` → `test_exp34_c_pass_testcases_conditional`
- ❌ FAIL `testcases_file_handle.c` → `test_exp34_c_pass_testcases_file_handle`
- ✅ PASS `testcases_guard_func.c` → `test_exp34_c_pass_testcases_guard_func`
- ❌ FAIL `testcases_linked_list.c` → `test_exp34_c_pass_testcases_linked_list`
- ❌ FAIL `testcases_null_check.c` → `test_exp34_c_pass_testcases_null_check`
- ❌ FAIL `testcases_safe_alloc.c` → `test_exp34_c_pass_testcases_safe_alloc`
- ✅ PASS `testcases_string_safe.c` → `test_exp34_c_pass_testcases_string_safe`
- ❌ FAIL `testcases_struct_ptr.c` → `test_exp34_c_pass_testcases_struct_ptr`
- ✅ PASS `wiki_compliant_1.c` → `test_exp34_c_pass_wiki_compliant_1`
- ❌ FAIL `wiki_compliant_2.c` → `test_exp34_c_pass_wiki_compliant_2`
- ✅ PASS `wiki_compliant_3.c` → `test_exp34_c_pass_wiki_compliant_3`
...
**Implementation Status:** 2 / 35 rules (5.7%)
...
**Test Results:** 43/48 passed (89.6%)
...
- ❌ FAIL `testcases_cast_to_char.c` → `test_fio34_c_fail_testcases_cast_to_char`
...
- ❌ FAIL `testcases_no_eof_check.c` → `test_fio34_c_fail_testcases_no_eof_check`
- ❌ FAIL `testcases_no_error_check.c` → `test_fio34_c_fail_testcases_no_error_check`
...
- ❌ FAIL `wiki_noncompliant_1.c` → `test_fio34_c_fail_wiki_noncompliant_1`
- ✅ PASS `wiki_nonportable.c` → `test_fio34_c_fail_wiki_nonportable`
- ❌ FAIL `wiki_wide_characters.c` → `test_fio34_c_fail_wiki_wide_characters`
...
**Test Results:** 21/45 passed (46.7%)
...
- ❌ FAIL `testcases_vuln_concat.c` → `test_fio30_c_fail_testcases_vuln_concat`
- ✅ PASS `testcases_vuln_config.c` → `test_fio30_c_fail_testcases_vuln_config`
- ❌ FAIL `testcases_vuln_dprintf.c` → `test_fio30_c_fail_testcases_vuln_dprintf`
- ❌ FAIL `testcases_vuln_dynamic.c` → `test_fio30_c_fail_testcases_vuln_dynamic`
...
- ❌ FAIL `testcases_vuln_fprintf.c` → `test_fio30_c_fail_testcases_vuln_fprintf`
- ❌ FAIL `testcases_vuln_fscanf.c` → `test_fio30_c_fail_testcases_vuln_fscanf`
...
- ❌ FAIL `testcases_vuln_indirect.c` → `test_fio30_c_fail_testcases_vuln_indirect`
- ❌ FAIL `testcases_vuln_malloc.c` → `test_fio30_c_fail_testcases_vuln_malloc`
- ❌ FAIL `testcases_vuln_network.c` → `test_fio30_c_fail_testcases_vuln_network`
- ❌ FAIL `testcases_vuln_pointer.c` → `test_fio30_c_fail_testcases_vuln_pointer`
...
- ❌ FAIL `testcases_vuln_scanf.c` → `test_fio30_c_fail_testcases_vuln_scanf`
- ❌ FAIL `testcases_vuln_snprintf.c` → `test_fio30_c_fail_testcases_vuln_snprintf`
- ✅ PASS `testcases_vuln_sprintf.c` → `test_fio30_c_fail_testcases_vuln_sprintf`
- ❌ FAIL `testcases_vuln_sscanf.c` → `test_fio30_c_fail_testcases_vuln_sscanf`
- ✅ PASS `testcases_vuln_struct.c` → `test_fio30_c_fail_testcases_vuln_struct`
- ❌ FAIL `testcases_vuln_syslog.c` → `test_fio30_c_fail_testcases_vuln_syslog`
...
### 🔶 FIO37-C - Not Implemented (has tests)
...
**Test Results:** 36/56 passed (64.3%)

#### Fail Tests (Should Detect Violations)

- ❌ FAIL `testcases_abs_min.c` → `test_int32_c_fail_testcases_abs_min`
...
- ❌ FAIL `testcases_div_min.c` → `test_int32_c_fail_testcases_div_min`
...
- ❌ FAIL `wiki_noncompliant_4.c` → `test_int32_c_fail_wiki_noncompliant_4`
- ❌ FAIL `wiki_noncompliant_5.c` → `test_int32_c_fail_wiki_noncompliant_5`
...
- ❌ FAIL `testcases_abs_check.c` → `test_int32_c_pass_testcases_abs_check`
- ❌ FAIL `testcases_add_check.c` → `test_int32_c_pass_testcases_add_check`
- ❌ FAIL `testcases_array_idx.c` → `test_int32_c_pass_testcases_array_idx`
- ❌ FAIL `testcases_div_check.c` → `test_int32_c_pass_testcases_div_check`
- ❌ FAIL `testcases_incr_check.c` → `test_int32_c_pass_testcases_incr_check`
- ❌ FAIL `testcases_mul_check.c` → `test_int32_c_pass_testcases_mul_check`
- ❌ FAIL `testcases_neg_check.c` → `test_int32_c_pass_testcases_neg_check`
- ❌ FAIL `testcases_shift_check.c` → `test_int32_c_pass_testcases_shift_check`
- ❌ FAIL `testcases_size_calc.c` → `test_int32_c_pass_testcases_size_calc`
- ❌ FAIL `testcases_sub_check.c` → `test_int32_c_pass_testcases_sub_check`
- ✅ PASS `wiki_c23_checked_integers.c` → `test_int32_c_pass_wiki_c23_checked_integers`
- ❌ FAIL `wiki_compliant_1.c` → `test_int32_c_pass_wiki_compliant_1`
- ❌ FAIL `wiki_compliant_10.c` → `test_int32_c_pass_wiki_compliant_10`
- ❌ FAIL `wiki_compliant_11.c` → `test_int32_c_pass_wiki_compliant_11`
- ❌ FAIL `wiki_compliant_3.c` → `test_int32_c_pass_wiki_compliant_3`
- ❌ FAIL `wiki_compliant_5.c` → `test_int32_c_pass_wiki_compliant_5`
- ❌ FAIL `wiki_compliant_6.c` → `test_int32_c_pass_wiki_compliant_6`
...
### 🔶 INT18-C - Not Implemented (has tests)
...
### 🔶 MSC32-C - Not Implemented (has tests)
...
### 🔶 POS30-C - Not Implemented (has tests)
...
### 🔶 POS37-C - Not Implemented (has tests)
...
### 🔶 POS36-C - Not Implemented (has tests)
...
### 🔶 PRE09-C - Not Implemented (has tests)
...
**Implementation Status:** 0 / 7 rules (0.0%)
...
### 🔶 SIG30-C - Not Implemented (has tests)
...
### 🔶 SIG31-C - Not Implemented (has tests)
...
**Implementation Status:** 2 / 16 rules (12.5%)
...
### 🔶 STR38-C - Not Implemented (has tests)
...
**Implementation Status:** 0 / 6 rules (0.0%)
...
### 🔶 WIN02-C - Not Implemented (has tests)
...
### 🔶 WIN01-C - Not Implemented (has tests)
