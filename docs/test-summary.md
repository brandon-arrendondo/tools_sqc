...
- [API](#category-api) (6 implemented / 9 total)
  ...
  - ✅ [API09-C](#rule-api09c) - Implemented: Pass 2/2 (100.0%)
...
- [CON](#category-con) (3 implemented / 23 total)
  ...
  - ✅ [CON32-C](#rule-con32c) - Implemented: Pass 3/3 (100.0%)
  ...
  - ✅ [CON07-C](#rule-con07c) - Implemented: Pass 4/4 (100.0%)
  ...
  - ✅ [CON08-C](#rule-con08c) - Implemented: Pass 5/5 (100.0%)
...
- [FIO](#category-fio) (3 implemented / 35 total)
  ...
  - ✅ [FIO30-C](#rule-fio30c) - Implemented: Pass 49/50 (98.0%)
...
- ✅ PASS `wiki_noncompliant_1.c` → `test_api09_c_fail_wiki_noncompliant_1`

#### Pass Tests (Should NOT Detect Violations)

- ✅ PASS `wiki_compliant_1.c` → `test_api09_c_pass_wiki_compliant_1`
...
- ✅ PASS `wiki_bit_field.c` → `test_con32_c_fail_wiki_bit_field`

#### Pass Tests (Should NOT Detect Violations)

- ✅ PASS `wiki_bit_field_c11_mutex.c` → `test_con32_c_pass_wiki_bit_field_c11_mutex`
- ✅ PASS `wiki_c11.c` → `test_con32_c_pass_wiki_c11`
...
- ✅ PASS `wiki_addition_of_primitives.c` → `test_con07_c_fail_wiki_addition_of_primitives`

#### Pass Tests (Should NOT Detect Violations)

- ✅ PASS `wiki_atomic_compare_exchange_weak.c` → `test_con07_c_pass_wiki_atomic_compare_exchange_weak`
- ✅ PASS `wiki_atomic_struct.c` → `test_con07_c_pass_wiki_atomic_struct`
- ✅ PASS `wiki_mutex.c` → `test_con07_c_pass_wiki_mutex`
...
- ✅ PASS `wiki_noncompliant_1.c` → `test_con08_c_fail_wiki_noncompliant_1`
- ✅ PASS `wiki_noncompliant_2.c` → `test_con08_c_fail_wiki_noncompliant_2`
- ✅ PASS `wiki_noncompliant_3.c` → `test_con08_c_fail_wiki_noncompliant_3`

#### Pass Tests (Should NOT Detect Violations)

- ✅ PASS `wiki_compliant_1.c` → `test_con08_c_pass_wiki_compliant_1`
- ✅ PASS `wiki_compliant_2.c` → `test_con08_c_pass_wiki_compliant_2`
...
**Test Results:** 49/50 passed (98.0%)

#### Fail Tests (Should Detect Violations)

- ✅ PASS `testcases_vuln_array.c` → `test_fio30_c_fail_testcases_vuln_array`
...
- ✅ PASS `testcases_vuln_error.c` → `test_fio30_c_fail_testcases_vuln_error`
...
- ✅ PASS `testcases_vuln_function.c` → `test_fio30_c_fail_testcases_vuln_function`
- ✅ PASS `testcases_vuln_global.c` → `test_fio30_c_fail_testcases_vuln_global`
...
- ✅ PASS `testcases_vuln_network.c` → `test_fio30_c_fail_testcases_vuln_network`
...
- ✅ PASS `testcases_vuln_template.c` → `test_fio30_c_fail_testcases_vuln_template`
- ✅ PASS `testcases_vuln_vfprintf.c` → `test_fio30_c_fail_testcases_vuln_vfprintf`
- ✅ PASS `testcases_vuln_vprintf.c` → `test_fio30_c_fail_testcases_vuln_vprintf`
- ✅ PASS `testcases_vuln_vsnprintf.c` → `test_fio30_c_fail_testcases_vuln_vsnprintf`
- ✅ PASS `testcases_vuln_vsprintf.c` → `test_fio30_c_fail_testcases_vuln_vsprintf`
- ✅ PASS `testcases_vuln_warn.c` → `test_fio30_c_fail_testcases_vuln_warn`
- ✅ PASS `wiki_noncompliant_1.c` → `test_fio30_c_fail_wiki_noncompliant_1`
- ✅ PASS `wiki_posix.c` → `test_fio30_c_fail_wiki_posix`

#### Pass Tests (Should NOT Detect Violations)

- ✅ PASS `testcases_safe_const.c` → `test_fio30_c_pass_testcases_safe_const`
- ✅ PASS `testcases_safe_error.c` → `test_fio30_c_pass_testcases_safe_error`
- ✅ PASS `testcases_safe_errx.c` → `test_fio30_c_pass_testcases_safe_errx`
...
- ❌ FAIL `testcases_safe_vprintf.c` → `test_fio30_c_pass_testcases_safe_vprintf`
- ✅ PASS `testcases_safe_warn.c` → `test_fio30_c_pass_testcases_safe_warn`
