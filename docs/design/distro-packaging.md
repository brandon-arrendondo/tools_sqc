...
**`NOTICE` and `thirdparty/cert/` ship deliberately.** The tree carries SEI
CERT C material — rule titles and descriptions under CC BY 4.0, code examples
under MIT — and those two files are where the attribution and CMU's own notice
