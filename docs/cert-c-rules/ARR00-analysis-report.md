   ...
   **Function:** `check()` - Lines 42-154
   ...
   - **Node types handled:** assignment_expression, sizeof_expression, binary_expression, declaration,
   call_expression, for_statement, return_statement, subscript_expression
   ...
   **Could Extract To:**
   ...
   | Functions with Complexity > 10 | 5 | check_obvious_string_overflow (14), check_dangerous_functions (12),
   check_vla_declaration (13), etc. |
