...
The default manifest (``rules_templates/rules-all.toml``) enables 306 of the 311 implemented rules.
...
311 rules are implemented across 17 categories (306 enabled by default):
